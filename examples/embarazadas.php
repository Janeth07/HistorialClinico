...
$result = $mysqli->query("SELECT * FROM cpn")or die($mysqli->error);
//pre_r($result);
...
?>
 ...
 <div class="main-content" id="panel">
    ...
    <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <!-- Search form -->  
         <form>
         <h6 class="h1 text-white d-inline-block mb-0 derecha ">EMBARAZADAS</h6>
    ...
    <div class="header bg-primary pb-6">
      ...
      <i class="ni ni-single-02 text-primary"></i> Añadir Embarzada
       </button>
            </div>
          </div>
        </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Registro de Embarazadas</h3>
            </div>
            <!-- Light table -->
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="fondouterino">Fondo Uterino</th>
                    <th scope="col" class="sort" data-sort="peso">Peso</th>
                    <th scope="col" class="sort" data-sort="talla">Talla</th>
                    <th scope="col" class="sort" data-sort="imc">semanas</th>
