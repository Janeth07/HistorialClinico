...
$result = $mysqli->query("SELECT * FROM cronico")or die($mysqli->error);
//pre_r($result);
...
?>
 ...
 <div class="main-content" id="panel">
    ...
    <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <!-- Search form -->  
         <form>
         <h6 class="h1 text-white d-inline-block mb-0 derecha ">CRONICOS</h6>
    ...
    <div class="header bg-primary pb-6">
      ...
      <i class="ni ni-single-02 text-primary"></i> Añadir Cronicos
      </button>
            </div>
          </div>
        </div>
            ...
            <div class="modal-body">
              <form action="#" method="POST">
                <div class="row">
                  ...
                  <button type="button" type="submit" class="btn btn-info btn-round" data-dismiss="modal" value="enviar">
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Registro de Cronicos</h3>
            </div>
            <!-- Light table -->
